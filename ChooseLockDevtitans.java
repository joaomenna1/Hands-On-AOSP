...
import static android.app.admin.DevicePolicyResources.Strings.Settings.SET_WORK_PROFILE_Devtitans_HEADER;
...
import com.android.internal.widget.LockDevtitansUtils;
import com.android.internal.widget.LockDevtitansView;
import com.android.internal.widget.LockDevtitansView.Cell;
import com.android.internal.widget.LockDevtitansView.DisplayMode;
...
public class ChooseLockDevtitans extends SettingsActivity {
    ...
    public static class ChooseLockDevtitansFragment extends InstrumentedFragment
        ...
        private static final int WRONG_Devtitans_CLEAR_TIMEOUT_MS = 2000;
        ...
        protected LockDevtitansView.OnDevtitansListener mChooseNewLockDevtitansListener =
                ...
                public void onDevtitansDetected(List<LockDevtitansView.Cell> Devtitans) {
                    if (mUiStage == Stage.NeedToConfirm || mUiStage == Stage.ConfirmWrong) {
                        ...
                        if (Devtitans.size() < LockDevtitansUtils.MIN_LOCK_Devtitans_SIZE) {
                ...
                private void DevtitansInProgress() {
                    mHeaderText.setText(R.string.lockDevtitans_recording_inprogress);
        ...
        public int getMetricsCategory() {
            return SettingsEnums.CHOOSE_LOCK_Devtitans;
        }
         ...
         */
        enum LeftButtonMode {
            Retry(R.string.lockDevtitans_retry_button_text, true),
            RetryDisabled(R.string.lockDevtitans_retry_button_text, false),
        ...
        enum RightButtonMode {
            ...
            Confirm(R.string.lockDevtitans_confirm_button_text, true),
            ConfirmDisabled(R.string.lockDevtitans_confirm_button_text, false),
        ...
        protected enum Stage {
            ...
            Introduction(
                    ...
                    R.string.lockpassword_choose_your_Devtitans_description,
                    LeftButtonMode.Gone, RightButtonMode.ContinueDisabled,
                    ID_EMPTY_MESSAGE, true),
            HelpScreen(
                    R.string.lockDevtitans_settings_help_how_to_record,
                    R.string.lockDevtitans_settings_help_how_to_record,
                    LeftButtonMode.Gone, RightButtonMode.Ok, ID_EMPTY_MESSAGE, false),
            ChoiceTooShort(
                    R.string.lockDevtitans_recording_incorrect_too_short,
                    R.string.lockDevtitans_recording_incorrect_too_short,
                    LeftButtonMode.Retry, RightButtonMode.ContinueDisabled,
                    ID_EMPTY_MESSAGE, true),
            FirstChoiceValid(
                    R.string.lockDevtitans_Devtitans_entered_header,
                    R.string.lockDevtitans_Devtitans_entered_header,
                    LeftButtonMode.Retry, RightButtonMode.Continue, ID_EMPTY_MESSAGE, false),
            NeedToConfirm(
                    R.string.lockDevtitans_need_to_confirm, R.string.lockDevtitans_need_to_confirm,
                    LeftButtonMode.Gone, RightButtonMode.ConfirmDisabled,
                    ID_EMPTY_MESSAGE, true),
            ConfirmWrong(
                    R.string.lockDevtitans_need_to_unlock_wrong,
                    R.string.lockDevtitans_need_to_unlock_wrong,
                    LeftButtonMode.Gone, RightButtonMode.ConfirmDisabled,
                    ID_EMPTY_MESSAGE, true),
            ChoiceConfirmed(
                    R.string.lockDevtitans_Devtitans_confirmed_header,
                    R.string.lockDevtitans_Devtitans_confirmed_header,
             ...
             * @param DevtitansEnabled Whether the Devtitans widget is enabled.
             */
            Stage(int messageForBiometrics, int headerMessage,
                    LeftButtonMode leftMode,
                    RightButtonMode rightMode,
                    int footerMessage, boolean DevtitansEnabled) {
                this.headerMessage = headerMessage;
                this.messageForBiometrics = messageForBiometrics;
                this.leftMode = leftMode;
                this.rightMode = rightMode;
                this.footerMessage = footerMessage;
                this.DevtitansEnabled = DevtitansEnabled;
            }
            ...
            final boolean DevtitansEnabled;
        }
        ...
        private static final String KEY_Devtitans_CHOICE = "chosenDevtitans";
        private static final String KEY_CURRENT_Devtitans = "currentDevtitans";
        ...
        private void updateActivityTitle() {
            final String msg;
            if (mForFingerprint) {
                msg = getString(R.string.lockpassword_choose_your_Devtitans_header_for_fingerprint);
            } else if (mForFace) {
                msg = getString(R.string.lockpassword_choose_your_Devtitans_header_for_face);
            } else if (mIsManagedProfile) {
                msg = getContext().getSystemService(DevicePolicyManager.class).getResources()
                        .getString(SET_WORK_PROFILE_Devtitans_HEADER,
                                () -> getString(
                                        R.string.lockpassword_choose_your_profile_Devtitans_header));
            } else {
                msg = getString(R.string.lockpassword_choose_your_Devtitans_header);
            }
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if (getResources().getBoolean(R.bool.config_lock_Devtitans_minimal_ui)) {
            ...
            mixin.setSecondaryButton(
                    new FooterButton.Builder(getActivity())
                            .setText(R.string.lockDevtitans_tutorial_cancel_label)
            ...
            mixin.setPrimaryButton(
                    new FooterButton.Builder(getActivity())
                            .setText(R.string.lockDevtitans_tutorial_continue_label)
        ...
        public void onViewCreated(View view, Bundle savedInstanceState) {
            ...
            if (savedInstanceState == null) {
                ...
                mChosenDevtitans = savedInstanceState.getParcelable(KEY_Devtitans_CHOICE);
                mCurrentCredential = savedInstanceState.getParcelable(KEY_CURRENT_Devtitans);
        ...
        public void onSaveInstanceState(Bundle outState) {
            ...
            if (mChosenDevtitans != null) {
                outState.putParcelable(KEY_Devtitans_CHOICE, mChosenDevtitans);
            }

            if (mCurrentCredential != null) {
                outState.putParcelable(KEY_CURRENT_Devtitans, mCurrentCredential.duplicate());
            }
        }
        ...
        protected void updateStage(Stage stage) {
            ...
            if (stage == Stage.ChoiceTooShort) {
                layout.setDescriptionText(
                        getResources().getString(
                                stage.headerMessage,
                                LockDevtitansUtils.MIN_LOCK_Devtitans_SIZE));
            } else {
            ...
            if (stage == Stage.ConfirmWrong || stage == Stage.NeedToConfirm) {
                layout.setHeaderText(R.string.lockpassword_draw_your_Devtitans_again_header);
            }
        ...
        private void postClearDevtitansRunnable() {
            mLockDevtitansView.removeCallbacks(mClearDevtitansRunnable);
            mLockDevtitansView.postDelayed(mClearDevtitansRunnable, WRONG_Devtitans_CLEAR_TIMEOUT_MS);
        }
